...
} from "../astro/assets-service_DsXAzEkC.mjs";
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "../astro/assets-service_DsXAzEkC.mjs"
    )
      .then((n) => n.h)
      .catch((e) => {
...
const $$Image = createComponent(
  ...
  "/Users/lravaglia/Projects/t5-tools/node_modules/astro/components/Image.astro",
  void 0,
);
...
const $$Picture = createComponent(
  ...
  "/Users/lravaglia/Projects/t5-tools/node_modules/astro/components/Picture.astro",
  void 0,
);
...
const outDir = new URL(
  "file:///Users/lravaglia/Projects/t5-tools/.vercel/output/static/",
);
