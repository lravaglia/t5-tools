import { l as O, t as oi, b as fi } from "./preact.module.C349affA.js";
var S,
  v,
  N,
  T,
...
(u.__b = function (t) {
  ...
  (u.diffed = function (t) {
    ...
    i &&
      i.__H &&
      (i.__H.__h.length &&
        ((L.push(i) !== 1 && T === u.requestAnimationFrame) ||
          ((T = u.requestAnimationFrame) || ui)(_i)),
...
function hi(t, i, n, r) {
  ...
  return {
    ...
    d: k(function () {
      ...
      r[i] !== _ &&
        ((r[i] = _),
        f ? (t[i] = _) : _ ? t.setAttribute(i, _) : t.removeAttribute(i));
    }),
  };
}
